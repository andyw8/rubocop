...
module RuboCop
  ...
  class Options
    ...
    def add_config_generation_options(opts)
      section(opts, 'Config Generation') do
        ...
        option(opts, '--regenerate-todo') { merge_in_todo_regeneration_options }
        option(opts, '--check-todo') { merge_in_todo_regeneration_options }
    ...
    def merge_in_todo_regeneration_options
  ...
  module OptionsHelp
    ...
    TEXT = {
      ...
      check_todo:                       ['Check whether the TODO configuration file',
